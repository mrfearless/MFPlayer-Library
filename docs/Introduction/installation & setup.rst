...
- Download the 32bit version of the MFPlayer Library: `MFPlayer-x86.zip <https://github.com/mrfearless/MFPlayer-Library/blob/master/releases/MFPlayer-x86.zip?raw=true>`_
...
- Download the 64bit version of the MFPlayer Library: `MFPlayer-x64.zip <https://github.com/mrfearless/MFPlayer-Library/blob/master/releases/MFPlayer-x64.zip?raw=true>`_
