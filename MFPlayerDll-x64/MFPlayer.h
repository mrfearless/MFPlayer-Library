...
bool MFP_EXPORT MFPMediaPlayer_GetPosition(IMFPMediaPlayer *pMediaPlayer, DWORD_PTR *pdwMilliseconds);
bool MFP_EXPORT MFPMediaPlayer_GetDuration(IMFPMediaPlayer *pMediaPlayer, DWORD_PTR *pdwMilliseconds);

bool MFP_EXPORT MFPMediaPlayer_SetRate(IMFPMediaPlayer *pMediaPlayer, DWORD dwRate);
bool MFP_EXPORT MFPMediaPlayer_GetRate(IMFPMediaPlayer *pMediaPlayer, DWORD_PTR *pdwRate);
bool MFP_EXPORT MFPMediaPlayer_GetSupportedRates(IMFPMediaPlayer *pMediaPlayer, BOOL bForwardDirection, DWORD_PTR *pdwSlowestRate, DWORD_PTR *pdwFastestRate);

bool MFP_EXPORT MFPMediaPlayer_GetVolume(IMFPMediaPlayer *pMediaPlayer, DWORD_PTR *pdwVolume);
bool MFP_EXPORT MFPMediaPlayer_SetVolume(IMFPMediaPlayer *pMediaPlayer, DWORD dwVolume);
bool MFP_EXPORT MFPMediaPlayer_GetBalance(IMFPMediaPlayer *pMediaPlayer, DWORD_PTR *pdwBalance);
...
bool MFP_EXPORT MFPMediaPlayer_GetAspectRatioMode(IMFPMediaPlayer *pMediaPlayer, DWORD_PTR *pdwAspectRatioMode);
...
bool MFP_EXPORT MFPMediaItem_GetDuration(IMFPMediaItem *pMediaItem, DWORD_PTR *pdwMilliseconds);
bool MFP_EXPORT MFPMediaItem_GetNumberOfStreams(IMFPMediaItem *pMediaItem, DWORD_PTR *pdwStreamCount);
...
// Media Information
bool MFP_EXPORT MFPMediaItem_StreamTable(IMFPMediaItem *pMediaItem, DWORD_PTR *lpdwStreamCount, DWORD64 *lpqwStreamTable);
